    ...
    <div class="container">
        ...
        <div class="account-sec-tab">
            <div class="account-info-tab">
                ...
                <div class="float active"> <span class="back"></span> <span class="mid"> <?php echo anchor('home/manageuserscontenthistory/'.$this->session->userdata('user_id') , 'View Content Posted') ?> </span> <span class="front"></span> </div>
        ...
        <div class="search">
            <div class="field">
                <div class="field">
                    <form action="<?php echo site_url('home/manageuserscontenthistory/'.$this->session->userdata('user_id'));?>" name="serach_post_by_title" method="get">
        ...
        <div class="grid grid5">
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="tblgrid">
                ...
                <tr <?php echo $class_alt ;?>>
                    <td ><?php echo anchor('home/editpost/'.$row['post_id'],$title); ?>	</td>
                    ...
                    <td ><div class="makepostdd">
                            <div class="mpddinner">
                                ...
                                <div class="mpmid">
                                    <ul>
                                        <li><?php echo anchor('home/editpost/'.$row['post_id'],'view'); ?></li>
                                        <li><?php echo anchor('home/viewpostmultimedia/'.$row['post_id'], 'View Multimedia');?></li>
                                        <li><?php echo anchor('home/blockposts/'.$row['post_id'],'Block post');?>
										</li>
