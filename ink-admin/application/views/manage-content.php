...
<div id="wrapper">
    ...
    <div class="container">
        ...
        <div class="search">
            <div class="field">
                <form action="<?php echo site_url('home/managecontent');?>" name="serach_post_by_title" method="get">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblgrid">
                ...
                <tr <?php echo $class_alt ;?>>
	                <td>
						...
						<?php echo anchor('home/editpost/'.$row['post_id'],$title); ?>
					</td>
                            ...
                            <div class="mpddinner">
                                ...
                                <div class="mpmid">
                                    <ul>
                                        ...
                                        <li><?php echo anchor('home/viewpostmultimedia/'.$row['post_id'], 'View Multimedia');?>
										</li>
										<li><?php echo anchor('home/viewComments/'.$row['post_id'], 'View Comments'); ?></li>
