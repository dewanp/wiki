...
<div id="wrapper"> 
  <div class="container"> 
    ...
    <div class="search">
      <div class="field"> 
        <form action="<?php echo site_url('home/allblockedposts');?>" name="serach_post_by_title" method="get">
    ...
    <div class="grid grid6"> 
      <div class="clear"></div>
	  <?php if(!empty($all_blocked_posts)) { ?>
      <table border="0" cellpadding="0" cellspacing="0" class="tblgrid">
        ...
        <?php  $i=0; foreach($all_blocked_posts as $row ){    
				  if($i%2==0)
					  $class_alt = "class = 'alt' ";	
				  else
					 $class_alt = "";	
		    ...
		    <td ><div class="makepostdd"> 
			  <div class="mpddinner"> 
				...
				<ul>
				  ...
				  <li><a href="javascript:void(0);" onClick="resumeBlockedPosts('<?php echo $row['post_id']?>');" >Resume post</a></li>
    ...
    <div class="pagination-region"> 
      <div class="rleft"><span class="left"></span> 
		</div>
