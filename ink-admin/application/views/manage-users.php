...
<div id="wrapper">
    ...
    <div class="container">
        <div class="maintitle">
            <h1>Manage Users</h1>
            <?php  //echo anchor('home/suspendeduserlist' ,'View Suspended Account Lists' ,'class="viewlink" ');?>
			<div class="search">
            ...
            <!-- <div class="btnbox">
                <?php  echo anchor('home/displayadduserview' , '<span class="add-icon"></span>Add User' , 'class="btnorange" ');?>
            </div> -->
        </div>
        <?php echo form_open('home/suspendusers');?>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblgrid">
                ...
                <tr  <?php echo $class_alt ;?>>
                    ...
                    <td >
							...
							<?php echo anchor('home/manageuserviewdetails/'.$row['user_id'], $row['profile_name'], 'style="position: relative;bottom:10px;"'); ?>
                    </td>
                    <td><?php echo anchor('home/manageuserviewdetails/'.$row['user_id'], $row['user_name']); ?></td>
                    <td><?php  echo $row['email'];?></td>
                    <td><?php echo int_to_date($row['registered_date']); ?></td>
                    <td class="textcenter"><?php echo anchor('home/manageuserscontenthistory/'.$row['user_id'],$row['content_posted']); ?></td>
                    <!-- <td>1</td> -->
                            ...
                            <div class="mpddinner">
                                ...
                                <div class="mpmid">
                                    <ul>
                                        ...
                                        <li> <?php echo anchor('home/suspendusers/'.$row['user_id'],'Suspend Account'); ?> </li>
