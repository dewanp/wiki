...
<?php foreach($options as $key => $option){?>
	...
	<div class="pollchoice">
		<div class="radio">
			<input type="radio" disabled="disabled" id="choice-<?php echo $option['option_id']?>" name="option_id[<?php echo $polls_id?>]" class="designer" <?php if($option['option_id']==$votedvalue){?>checked="checked"<?php }?>/>
