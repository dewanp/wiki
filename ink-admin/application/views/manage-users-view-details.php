    ...
    <div class="container">
        ...
        <div class="account-sec-tab">
            <div class="account-info-tab">
                <div class="float active"> <span class="back"><span class="unlimited"></span></span> <span class="mid"> <?php echo anchor('home/manageuserviewdetails/'.$this->session->userdata('user_id'), 'View User') ?> </span> <span class="front"></span> </div>
        ...
        <div id="manageuserdetails"> 
            ...
            <div class="rightdtls">
                <div class="titlebar">
                    ...
                    <?php echo anchor('home/manageuserseditdetails/'.$this->session->userdata('user_id'), 'Edit User details')?> </div>
                <div class="clear"></div>
               ...
               <div id="status_action_div" style="text-align:left;">
				...
				<?php $this->load->view('account-information'); ?>
               </div>
	...
	else
	{
		echo '<div class="logsignbox">
				<div class="loginmain error404main">
					<h2>No User Found</h2>
					<div class="btnbox" style="float:right;"> '.anchor('home/manageusers','<span class="back-icon"></span>Back to all users','class="btnorange"').'</div>
				</div>
			</div>';
	}
	?>
