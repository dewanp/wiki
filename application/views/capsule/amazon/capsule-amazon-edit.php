...
<div id="content-add-<?php echo $capsule_id?>" class="showcomment showcomment2">	
    ...
    <?php if($capsule_data['mandatory'] == 0){ ?>
        <a href="javascript:void(0)" onclick="prepareConfirmPopupCapsule(this,'Are you sure?')" class="image-orange" title="Delete Amazon"></a><div class="adl"><a href="javascript:void(0)" onclick="capsuleDelete('8','<?php echo $capsule_id?>','<?php echo $post_id?>')" class="btnorange">Yes</a></div>
   <?php }?>
    
    <a onclick="capsuleContent('<?php echo $post_id?>','<?php echo $capsule_id?>','update');" href="javascript:void(0);" class="btnorange">Edit Amazon</a>
    ...
    <div class="editbox"> 
        ...
        <div id="ctrlbar-<?php echo $capsule_id; ?>" style="display:none;">
                    ...
                    <div id="amazon-url-wrapper-<?php echo $capsule_id; ?>">
                        <?php if(!empty($capsule_content)){?>
                            ...
                            <div class="field-wrapper">
                                ...
                                <input type="text" class="inputmain" name="amazon_url[]" value="<?php echo $amazon['title']; ?>"/><a href="javascript:void(0);" class="delete"></a>
                                </div>
                                <div class="fieldmain">
                                    <label class="name">Enter Description</label>
                                    <textarea cols="" rows="" class="inputmain" name="amazon_description[]"></textarea>
                                </div>
                            </div>
                            <?php }?> 
                        <?php }?>                  
