...
<div class="infoboxmain">
	...
	<div class="<?php if($capsule_data['is_gallery']) echo 'cbox-selected'; else echo 'cbox';?>">
		<input type="checkbox" id="is_gallery" name="is_gallery" value="1" <?php if($capsule_data['is_gallery']) echo 'checked="checked"'; ?> />
		Gallery
	</div>
</div>
...
<?php if(!empty($capsule_content)){?>
	<?php foreach($capsule_content as $capsule_image){?>
		<div class="imageedit" id="uploaded-img-<?php echo $capsule_image['file_upload_id']?>">			
			...
			<div class="infobox" style="float:left; width:100%;">
...
<div id="add-more-img-button"><div id="progressbar"><div class="progress-label">Loading...</div></div><span id="status-<?php echo $capsule_id?>" ></span>
<a href="javascript:void(0);" class="addmore" id="upload-<?php echo $capsule_id?>" style="margin:4px;">Add Image</a>
</div>
