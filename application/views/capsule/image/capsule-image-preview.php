                    ...
                    <div class="ad-nav">
                        <div class="ad-thumbs">
                            <ul class="ad-thumb-list">
								...
								?>
                                <li>
                                <a href="<?php echo $orgnl_file_from_amazon;?>"><img src="" alt="" width="113" height="72" class="image<?php echo $r?>" id="gallery-<?php echo $capsule_content_row['file_upload_id'];?>"/></a></li> 
