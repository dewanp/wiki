...
<link rel="stylesheet" type="text/css" href="<?php echo site_url().'css/admin-jquery-ui.css'; ?>"/>
<link rel="stylesheet" type="text/css" href="<?php echo site_url().'css/editpost.css'; ?>"/>
<link rel="stylesheet" type="text/css" href="<?php echo site_url().'css/fixes.css'; ?>"/>


<script type="text/javascript" src="<?php echo site_url().'javascript/jquery-1.7.2.min.js'; ?>"></script>
...
<script type="text/javascript" src="<?php echo site_url().'javascript/jquery-ui.js'; ?>"></script>
<script type="text/javascript" src="<?php echo site_url().'javascript/common.js'; ?>"></script>
<script type="text/javascript" src="<?php echo site_url().'javascript/label-infields.js'; ?>"></script>
<script type="text/javascript" src="<?php echo site_url().'javascript/custom-form-elements.js'; ?>"></script>
<script type="text/javascript" src="<?php echo site_url().'javascript/admin.js'; ?>"></script>
<script type="text/javascript" src="<?php echo site_url().'javascript/admin-common.js'; ?>"></script>
<script type="text/javascript" src="<?php echo site_url().'javascript/ajaxupload.js'; ?>"></script>
<script type="text/javascript" src="<?php echo site_url().'javascript/nicEdit.js'; ?>"></script>
...
<div id="header-main">
    <div class="header">
        <div class="headerin">
			...
			<?php echo anchor('admin/dashboard', '<img src="images/wiki.png" alt="" width="171" height="66" />') ?>
			</div>
                    ...
                    <div class="user-login">
                        ...
                        <div class="loginbox" id="loginbox" style="display:none;">
                            <ul>
                                ...
                                <li>
                                    <?php echo anchor('admin/viewchangepassword','<span class="account"></span>Change Password'); ?>
                                </li>
                                <!-- <li><a href="javascript:void(0);"><span class="unpublish"></span>Unpublished Content</a></li> -->
								<li> 
									<?php echo anchor('admin/logout', '<span class="logout"></span>Logout'); ?> 
                                </li>
		...
		?>
            <ul>
                <li class="home">
					<?php echo anchor('admin/dashboard','Home<span class="arrow"></span>',$admin);?>
				</li>
                <li class="local-post">
					<?php echo anchor ('admin/manageusers','Manage Users<span class="arrow"></span>',$manage_user); ?>
				</li>
                <li class="local-post">
					<?php echo anchor ('admin/managecontent','Manage Content<span class="arrow"></span>',$manage_content);?>
				</li>                
                <li class="local-post">
	                <?php echo anchor ('admin/displaycategorylist','Manage Category<span class="arrow"></span>',$category);?>
                </li>
