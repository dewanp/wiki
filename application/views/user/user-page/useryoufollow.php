<div class="info-block mart18">You following  <b> <?php echo count($users);?> </b>  users</div>
<div class="urow">
...
<div class="userbox">
	...
	<div class="ubot">
		<div class="ubotnav"> <a href="javascript:void(0);" onclick="unfollowUser('<?php echo $user['user_follow_id']?>')">Un-Follow<img src="images/cross.png" alt="" /></a> 
		  Report Abuse<img src="images/cross.png" alt="" /> </div>
	</div>
