<div id="wrapper-home">
    <div class="wrapperin">
        <div class="lefthome">
            <h1>Wish to show your 
                content to the world?</h1>
            <h4>Have no boundaries. Select your pick and make a post.  It can be a gallery, videos, blogs, recipes, anything you wish to create.</h4>
            <div class="join">
                <div class="circle"></div>
            </div>
            <div class="viewbtnbox"> 
				<?php echo anchor('post/showposts/all' , '<span class="cat-icon"></span> <span class="titleor">View all posts</span> <span class="titlegrey">View a list of all Post. </span> <span class="arrow"></span>' , 'class="viewbtn" '); ?>
        ...
        <div class="righthome">
            <div class="videosec"> <iframe width="510" height="346" src="http://www.youtube.com/embed/nPPM_qahJE0?rel=0" frameborder="0" allowfullscreen></iframe></div>
            <div class="form-home">
                <?php	$hidden = array('save'=>'save');  
                    ...
                    <div class="cbox">
                        ...
                        I agree to the <?php echo anchor('page/underconstruction/Terms and Condition','Terms and Conditions','target="_blank"');?> 
