...
if (is_uploaded_file(@$_FILES['userfile']['tmp_name'])) {
	...
	$phpThumb->setSourceData(file_get_contents('http://dev-carats-and-cake-upload.s3.amazonaws.com/uploads/files/28/mainimg/thumb_4/1350493038Desert.jpg'));
